...
#include "moy/MoyCombine.cpp.inc"
} // namespace
...
/// Register out patterns as "canonicalization" patterns on the TransposeOp so
...
void ReshapeOp::getCanonicalizationPatterns(RewritePatternSet &results, MLIRContext *context) {
    results.add<RedundantReshapeOptPattern, RedundantReshapeOptPattern,
