...
private:
    ...
    mlir::Value mlirGen(BinaryExprAST &binop) {
        ...
        // 1) First it will visit the LHS, which will return a reference to the
    ...
    mlir::Value mlirGen(ExprAST &expr) {
        switch (expr.getKind()) {
            case moy::ExprAST::Expr_BinOp:
                return mlirGen(cast<BinaryExprAST>(expr));
            case moy::ExprAST::Expr_Var:
                return mlirGen(cast<VariableExprAST>(expr));
            case moy::ExprAST::Expr_Literal:
                return mlirGen(cast<LiteralExprAST>(expr));
            case moy::ExprAST::Expr_Call:
                return mlirGen(cast<CallExprAST>(expr));
            case moy::ExprAST::Expr_Num:
